...
router.get('/', rejectUnauthenticated, (req, res) => {
    const queryText = `
        ...
        FROM 
            "student"
        JOIN 
            "strep_throat" ON "student"."id" = "strep_throat"."student_id"
...
router.post('/', rejectUnauthenticated, (req, res) => {
    ...
    const insertIllnessInputQuery = `
        INSERT INTO "strep_throat" ("illness_id", "symptoms", "illness_date", "student_id")
        VALUES ($1, $2, $3, $4)
    `;
...
router.put('/:id', (req, res) => {
    ...
    const updateIllnessQuery = `
        UPDATE "illness"
        SET "name" = $1
        WHERE "id" = (SELECT "illness_id" FROM "strep_throat" WHERE "student_id" = $2)
    `;
