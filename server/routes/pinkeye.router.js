...
router.get('/', rejectUnauthenticated, (req, res) => {
    const queryText = `
        SELECT 
            ...
            "student"."first_name", 
            "student"."grade", 
            "pink_eye"."illness_date", 
            "illness"."name", 
            "pink_eye"."symptoms"
        FROM 
            "student"
        JOIN 
            "pink_eye" ON "student"."id" = "pink_eye"."student_id"
...
router.post('/', rejectUnauthenticated, (req, res) => {
    ...
    const insertIllnessInputQuery = `
        INSERT INTO "pink_eye" ("illness_id", "symptoms", "illness_date", "student_id")
        VALUES ($1, $2, $3, $4)
    `;
            ...
            return pool.query(insertIllnessQuery, illnessValues)
                .then((illnessResult) => {
                    ...
                    return pool.query(insertIllnessInputQuery, illnessInputValues)
                        ...
                        .catch((error) => {
                            console.error('Error inserting into pink_eye:', error);
                            res.sendStatus(500);
                        });
                })
                .catch((error) => {
...
router.put('/:id', (req, res) => {
    ...
    const updateIllnessQuery = `
        UPDATE "illness"
        SET "name" = $1
        WHERE "id" = (SELECT "illness_id" FROM "pink_eye" WHERE "student_id" = $2)
    `;
